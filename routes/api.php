...
$router->group(['middleware' => 'auth:api'], function(Router $router) {
	...
	$router->group(['prefix' => 'v1'], function(Router $router) {
		...
		$router->group(['prefix' => 'banking'], function(Router $router) {
			...
			$router->get('accounts', V1\BankingController::class . '@getAccounts')->name('banking.accounts');
			$router->post('accounts/{id}', V1\BankingController::class . '@updateAccount')->name('banking.account.update');
